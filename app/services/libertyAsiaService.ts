...
export class LibertyAsiaService{
    ...
    authURL:string = "http://192.168.15.107:8080/alfresco/service/api/login";
    //submitURL:string = "http://192.168.15.101:8080/alfresco/service/seeksystem/mediamonitoring/createnode?alf_ticket=";
    submitURL:string = "http://192.168.15.107:8080/alfresco/service/seeksystem/mediamonitoring/createnode";
    //getNgoCodeURL:string = "http://192.168.15.101:8080/alfresco/service/seeksystem/mediamonitoring/ngocodes?alf_ticket=";
    getNgoCodeURL:string = "http://192.168.15.107:8080/alfresco/service/seeksystem/mediamonitoring/ngocodes";
