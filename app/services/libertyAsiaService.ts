...
export class LibertyAsiaService{
    ...
    //submitURL:string = "http://192.168.15.108:8080/alfresco/service/seeksystem/mediamonitoring/createnode";
    submitURL:string = "https://www.seeksystem.org/alfresco/service/seeksystem/mediamonitoring/createnode";
    //getNgoCodeURL:string = "http://192.168.15.108:8080/alfresco/service/seeksystem/mediamonitoring/ngocodes";
